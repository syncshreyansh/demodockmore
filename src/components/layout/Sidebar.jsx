      ...
      <aside className="sidebar-scroll w-[260px] lg:w-[290px] h-full bg-sidebar flex flex-col justify-between py-6 px-5 lg:px-7 shrink-0 overflow-y-auto md:overflow-y-hidden md:hover:overflow-y-auto select-none [scrollbar-gutter:stable]">
        ...
        <div className="flex flex-col gap-5">
          ...
          <div>
            ...
            {/* Connected Accounts List - Surfacing ALL connected accounts with scroll support */}
        ...
        <div className="flex flex-col gap-3 mt-auto pt-8">
          ...
          <div className="relative mt-1" ref={profileRef}>
            ...
            {menuOpen && (
              <div className="absolute bottom-full left-0 right-0 mb-2 p-1.5 backdrop-blur-md bg-white/70 border border-white/60 rounded-2xl shadow-lg z-50 flex flex-col gap-1 transition-all duration-150 animate-fade-in">
                <button
                  type="button"
                  onClick={() => {
                    setMenuOpen(false);
